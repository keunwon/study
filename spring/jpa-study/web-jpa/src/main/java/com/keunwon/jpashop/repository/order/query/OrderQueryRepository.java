...
public class OrderQueryRepository {
    ...
    public List<OrderFlatDto> findAllByDtoFlat() {
        return em.createQuery(
                "select new com.keunwon.jpashop.repository.order.query.OrderFlatDto" +
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
        List<OrderItemQueryDto> orderItems = em.createQuery(
                "select new com.keunwon.jpashop.repository.order.query.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" +
                        " from OrderItem oi" +
                        " join oi.item i" +
    ...
    private List<OrderQueryDto> findOrders() {
        return em.createQuery(
                "select new com.keunwon.jpashop.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address)" +
                        " from Order o" +
                        " join o.member m" +
