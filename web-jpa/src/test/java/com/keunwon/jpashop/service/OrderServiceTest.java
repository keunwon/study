...
import com.keunwon.jpashop.domain.item.Book;
import com.keunwon.jpashop.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문 취소시 상태는 CCANCEL 이다.", OrderStatus.CANCEL, getOrder.getStatus());
        assertEquals("주민이 취소된 상품은 그만큼 재고가 증가해야 한다.", 10, item.getStockQuantity());
    }
