...
import com.ch10.jkid.asJavaClass
import com.ch10.jkid.isPrimitiveOrString
import com.ch10.jkid.serializerForBasicType
...
class ObjectListSeed(
    ...
    override fun spawn() = elements.map { it.spawn() }
...
class ValueListSeed(
    ...
    override fun createCompositeProperty(propertyName: String, isList: Boolean): JsonObject {
        throw JKidException("Found object value in collection primitive types")
    }
}
